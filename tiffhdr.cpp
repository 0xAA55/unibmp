...
{
	constexpr std::pair<uint16_t, const char*> IFDTagToStr_data[] =
	{
		{0x0001, "InteropIndex"},
		...
		{0x010f, "Make"},
		{0x0110, "Model"},
		{0x0111, "JpgFromRawStartJpgFromRawStart|OtherImageStartOtherImageStart|PreviewImageStartPreviewImageStart|StripOffsets|StripOffsetsStripOffsets"},
		{0x0112, "Orientation"},
		{0x0115, "SamplesPerPixel"},
		{0x0116, "RowsPerStrip"},
		{0x0117, "JpgFromRawLengthJpgFromRawLength|OtherImageLengthOtherImageLength|PreviewImageLengthPreviewImageLength|StripByteCounts|StripByteCountsStripByteCounts"},
		...
		{0x014a, "A100DataOffsetA100DataOffset|SubIFD"},
		{0x014c, "InkSet"},
		{0x014d, "InkNames"},
		{0x014e, "NumberofInks"},
		{0x0150, "DotRange"},
		...
		{0x01b5, "JPEGTables"},
		{0x0200, "JPEGProc"},
		{0x0201, "JpgFromRawStartJpgFromRawStart|OtherImageStartOtherImageStart|PreviewImageStartPreviewImageStart|ThumbnailOffset|ThumbnailOffsetThumbnailOffset"},
		{0x0202, "JpgFromRawLengthJpgFromRawLength|OtherImageLengthOtherImageLength|PreviewImageLengthPreviewImageLength|ThumbnailLength|ThumbnailLengthThumbnailLength"},
		...
		{0x923c, "CIP3Side"},
		{0x923f, "StoNits"},
		{0x927c, "MakerNoteApple|MakerNoteCanonMakerNoteCanon|MakerNoteCasio2MakerNoteCasio2|MakerNoteCasioMakerNoteCasio|MakerNoteDJIInfoMakerNoteDJIInfo|MakerNoteDJIMakerNoteDJI|MakerNoteFLIRMakerNoteFLIR|MakerNoteFujiFilmMakerNoteFujiFilm|MakerNoteGE2MakerNoteGE2|MakerNoteGEMakerNoteGE|MakerNoteHP2MakerNoteHP2|MakerNoteHP4MakerNoteHP4|MakerNoteHP6MakerNoteHP6|MakerNoteHPMakerNoteHP|MakerNoteHasselbladMakerNoteHasselblad|MakerNoteISLMakerNoteISL|MakerNoteJVCMakerNoteJVC|MakerNoteJVCTextMakerNoteJVCText|MakerNoteKodak10MakerNoteKodak10|MakerNoteKodak11MakerNoteKodak11|MakerNoteKodak12MakerNoteKodak12|MakerNoteKodak1aMakerNoteKodak1a|MakerNoteKodak1bMakerNoteKodak1b|MakerNoteKodak2MakerNoteKodak2|MakerNoteKodak3MakerNoteKodak3|MakerNoteKodak4MakerNoteKodak4|MakerNoteKodak5MakerNoteKodak5|MakerNoteKodak6aMakerNoteKodak6a|MakerNoteKodak6bMakerNoteKodak6b|MakerNoteKodak7MakerNoteKodak7|MakerNoteKodak8aMakerNoteKodak8a|MakerNoteKodak8bMakerNoteKodak8b|MakerNoteKodak8cMakerNoteKodak8c|MakerNoteKodak9MakerNoteKodak9|MakerNoteKodakUnknownMakerNoteKodakUnknown|MakerNoteKyoceraMakerNoteKyocera|MakerNoteLeica10MakerNoteLeica10|MakerNoteLeica2MakerNoteLeica2|MakerNoteLeica3MakerNoteLeica3|MakerNoteLeica4MakerNoteLeica4|MakerNoteLeica5MakerNoteLeica5|MakerNoteLeica6MakerNoteLeica6|MakerNoteLeica7MakerNoteLeica7|MakerNoteLeica8MakerNoteLeica8|MakerNoteLeica9MakerNoteLeica9|MakerNoteLeicaMakerNoteLeica|MakerNoteMinolta2MakerNoteMinolta2|MakerNoteMinolta3MakerNoteMinolta3|MakerNoteMinoltaMakerNoteMinolta|MakerNoteMotorolaMakerNoteMotorola|MakerNoteNikon2MakerNoteNikon2|MakerNoteNikon3MakerNoteNikon3|MakerNoteNikonMakerNoteNikon|MakerNoteNintendoMakerNoteNintendo|MakerNoteOlympus2MakerNoteOlympus2|MakerNoteOlympus3MakerNoteOlympus3|MakerNoteOlympusMakerNoteOlympus|MakerNotePanasonic2MakerNotePanasonic2|MakerNotePanasonic3MakerNotePanasonic3|MakerNotePanasonicMakerNotePanasonic|MakerNotePentax2MakerNotePentax2|MakerNotePentax3MakerNotePentax3|MakerNotePentax4MakerNotePentax4|MakerNotePentax5MakerNotePentax5|MakerNotePentax6MakerNotePentax6|MakerNotePentaxMakerNotePentax|MakerNotePhaseOneMakerNotePhaseOne|MakerNoteReconyx2MakerNoteReconyx2|MakerNoteReconyx3MakerNoteReconyx3|MakerNoteReconyxMakerNoteReconyx|MakerNoteRicoh2MakerNoteRicoh2|MakerNoteRicohMakerNoteRicoh|MakerNoteRicohPentaxMakerNoteRicohPentax|MakerNoteRicohTextMakerNoteRicohText|MakerNoteSamsung1aMakerNoteSamsung1a|MakerNoteSamsung1bMakerNoteSamsung1b|MakerNoteSamsung2MakerNoteSamsung2|MakerNoteSanyoC4MakerNoteSanyoC4|MakerNoteSanyoMakerNoteSanyo|MakerNoteSanyoPatchMakerNoteSanyoPatch|MakerNoteSigmaMakerNoteSigma|MakerNoteSony2MakerNoteSony2|MakerNoteSony3MakerNoteSony3|MakerNoteSony4MakerNoteSony4|MakerNoteSony5MakerNoteSony5|MakerNoteSonyEricssonMakerNoteSonyEricsson|MakerNoteSonyMakerNoteSony|MakerNoteSonySRFMakerNoteSonySRF|MakerNoteUnknown|MakerNoteUnknownBinaryMakerNoteUnknownBinary|MakerNoteUnknownTextMakerNoteUnknownText"},
		{0x9286, "UserComment"},
		{0x9290, "SubSecTime"},
		...
		{0xc633, "ShadowScale"},
		{0xc634, "DNGAdobeDataDNGAdobeData|DNGPrivateDataDNGPrivateData|MakerNoteDJIInfoMakerNoteDJIInfo|MakerNotePentax5MakerNotePentax5|MakerNotePentaxMakerNotePentax|MakerNoteRicohPentaxMakerNoteRicohPentax|SR2Private"},
	...
	constexpr std::pair<const char*, uint16_t> IFDTagFromStr_data[] =
	{
		{"InteropIndex", 0x0001},
	...
	template<typename T_V, size_t N>
	const std::unordered_map<std::string, T_V> DataToMap(const std::pair<const char*, T_V>(&cdata)[N])
	{
		std::unordered_map<std::string, T_V> ret;
	...
	template<typename T_K, size_t N>
	const std::unordered_map<T_K, std::string> DataToMap(const std::pair<T_K, const char*>(&cdata)[N])
	{
		std::unordered_map<T_K, std::string> ret;
		for (size_t i = 0; i < N; i++)
		{
			ret.insert({ cdata[i].first, cdata[i].second });
		}
	...
	const std::unordered_map<uint16_t, std::string> IFDTagToStr = DataToMap(IFDTagToStr_data);
	const std::unordered_map<std::string, uint16_t> IFDTagFromStr = DataToMap(IFDTagFromStr_data);
